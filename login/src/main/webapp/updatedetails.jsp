...
body {
	background-image:
		url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEqCwbbnJvfYWOyMKlXo2mZ8uaMFfJGISBrA&usqp=CAU");
	background-size: 100%;
		...
		<div class="container">
			...
			<div>
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="nav-item-active" style="color: white;">${LoginDTO.email}</li>
					<li class="nav-item-active"><img
						src="status/image?fileName=${LoginDTO.fileName}" width="100"
						height="50" style="border-radius: 80px" /></li>
				</ul>
			</div>
		</div>
	</div>
	<h2 style="text-align: center; font-style: oblique;">${message}</h2>
	<marquee style="color: green;" scrollamount="20">
	...
	<div class="main">
		...
		<form action="update" method="post" enctype="multipart/form-data">
			<label>Name</label> <input type="text" name="name"
				value="${LoginDTO.name}"> <label>Email</label> <input
				type="email" name="email" placeholder="Enter Your Same Email"
				value="${LoginDTO.email}" disabled="disabled"><input
				type="email" name="email" placeholder="Enter Your Same Email"
				value="${LoginDTO.email}" hidden=""> <label>Mobile
				Number</label> <input type="text" name="mobileNumber"
				placeholder="Mobile Number" value="${LoginDTO.mobileNumber}">
			<label>File</label> <input type="file" name="file"> <label>Agreement</label>
